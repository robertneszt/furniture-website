			    	        ...
			    	        <div class="header-search-form">
			    	            <form role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
			    	                <select class="header-search-select" name="product_cat">
			    	                    <option value=""><?php esc_html_e('All Categories', 'bosa-ecommerce'); ?></option> 
			    	                    <?php
			    	                ...
			    	                <input class="header-search-input" name="s" type="text" placeholder="<?php esc_attr_e('Search products...', 'bosa-ecommerce'); ?>"/>
				...
				<div class="col-md-3 d-none d-md-block">
					<?php if ( class_exists('WooCommerce' ) ) { ?>
					    <div class="header-right hidden-xs" >
					        <?php
					        if( !get_theme_mod( 'disable_woocommerce_compare', false ) ){ bosa_ecommerce_head_compare();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_wishlist', false ) ){ bosa_ecommerce_head_wishlist();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_account', false ) ){ bosa_ecommerce_my_account();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_cart', false ) ){ bosa_ecommerce_header_cart();
					        }
					        ?>
					    </div>	
					<?php } ?>
			...
			<div class="row align-items-center">
				<div class="col-lg-9 d-none d-lg-block">
					<nav id="site-navigation" class="main-navigation d-none d-lg-flex">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'bosa-ecommerce' ); ?></button>
